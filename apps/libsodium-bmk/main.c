...
tv_hchacha20(void)
{
    ...
    unsigned char constant[crypto_core_hchacha20_CONSTBYTES];
    unsigned char key[crypto_core_hchacha20_KEYBYTES];
    unsigned char in[crypto_core_hchacha20_INPUTBYTES];
    unsigned char out[crypto_core_hchacha20_OUTPUTBYTES];
    unsigned char out2[crypto_core_hchacha20_OUTPUTBYTES];
    size_t             i;
