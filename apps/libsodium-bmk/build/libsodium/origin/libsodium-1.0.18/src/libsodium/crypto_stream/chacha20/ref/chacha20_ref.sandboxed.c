                       ...
                       unsigned long long bytes)
{
    ...
    for (;;) {
        ...
        /* LCOV_EXCL_STOP */
        store32_le_morello(c + 0, x0);
        store32_le_morello(c + 4, x1);
        store32_le_morello(c + 8, x2);
        store32_le_morello(c + 12, x3);
        store32_le_morello(c + 16, x4);
        store32_le_morello(c + 20, x5);
        store32_le_morello(c + 24, x6);
        store32_le_morello(c + 28, x7);
        store32_le_morello(c + 32, x8);
        store32_le_morello(c + 36, x9);
        store32_le_morello(c + 40, x10);
        store32_le_morello(c + 44, x11);
        store32_le_morello(c + 48, x12);
        store32_le_morello(c + 52, x13);
        store32_le_morello(c + 56, x14);
        store32_le_morello(c + 60, x15);
